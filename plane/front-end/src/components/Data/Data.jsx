...
const tableauCode = (tableauRef) => {
    // var divElement = document.getElementById('viz1594394477583')
    // var vizElement = divElement.getElementsByTagName('object')[0]
    console.log(tableauRef);
    // tableauRef.childNodes[1].style.width = '100%'
    // tableauRef.object.style.height = (tableauRef.offsetWidth * 0.75) + 'px'
    // var scriptElement = document.createElement('script')
    // scriptElement.src = 'https://public.tableau.com/javascripts/api/viz_v1.js'
    // tableauRef.object.parentNode.insertBefore(scriptElement, tableauRef.object)
}
...
export default function Data() {
    return (
        <div>
            <div ref={tableauRef} class='tableauPlaceholder' id='viz1594394477583' style={{position: "relative"}}>
                <a href='#'>
